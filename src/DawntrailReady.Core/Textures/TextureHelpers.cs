// Port of xivModdingFramework Textures/TextureHelpers.cs (TexTools, GPL-3.0), all methods.
...
/// <summary>
/// Stand-in for SharpDX.Color4 (Red, Green, Blue, Alpha floats; the indexer maps 0..3 to R, G, B, A),
/// used by <see cref="TextureHelpers.AlphaBlendExplicit"/>.
/// </summary>
...
public static class TextureHelpers
{
    ...
    public static async Task FillChannel(byte[] data, int width, int height, int channel, byte value)
    {
        Action<int> act = (i) =>
        {
